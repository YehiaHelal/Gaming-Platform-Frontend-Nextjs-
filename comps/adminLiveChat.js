...
const LiveChat = () => {
  ...
  //       "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/openchat/",
  //       {
  //         submission,
  //       },
  //       {
  ...
  const HandleGetMessagesActiveChatPanel = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/activechatpanel/",
        formData,
        {
          withCredentials: true,
          headers: {
  ...
  const handleSendingMessages = async (e, chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminsendingchat/",
        {
          submission,
        },
        {
  ...
  const HandleAdminTurnJoinChat = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminjoinchat/",
        {
          submission,
        },
        {
  ...
  const HandleAdminMarkChatComplete = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminmarkchatcomplete/",
        {
          submission,
        },
        {
  ...
  const HandleAdminAddNoteToChat = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminaddnotetochat/",
        {
          submission,
        },
        {
  ...
  const HandleMarkForManger = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminmarkformanger/",
        {
          submission,
        },
        {
  ...
  const HandleBlockUser = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/users/adminblockuseremail/",
        {
          submission,
        },
        {
  ...
  return (
    <div className={styles.LiveChatComponent}>
      ...
      <div className={styles.ButtonTopNavigation}>
        <button
          style={{
            background: showActiveChat === true ? "rgb(0, 0, 255, 0.4)" : "",
          }}
          onClick={() => {
            HandleGetMessagesActiveChatPanel();
        ...
        <button
          style={{
            background: showArchivedChat === true ? "rgb(0, 0, 255, 0.4)" : "",
          }}
          onClick={() => {
                  ...
                  return (
                    ...
                    >
                      <div className={styles.chatUserInfo}>
                        ...
                        <div>
                          Note :{" "}
                          {chat.note === true ? chat.note : "No note was added"}
                        </div>
                        <div>
                          Joined:{" "}
                          {chat.joined === true
