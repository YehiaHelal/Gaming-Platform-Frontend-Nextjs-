...
const LiveChat = () => {
  ...
  //       "https://pharmacyonline.onrender.com/api/users/openchat/",
  //       {
  //         submission,
  //       },
  //       {
  ...
  const HandleGetMessagesActiveChatPanel = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/activechatpanel/",
        formData,
        {
          withCredentials: true,
          headers: {
  ...
  const handleSendingMessages = async (e, chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminsendingchat/",
        {
          submission,
        },
        {
  ...
  const HandleAdminTurnJoinChat = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminjoinchat/",
        {
          submission,
        },
        {
  ...
  const HandleAdminMarkChatComplete = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminmarkchatcomplete/",
        {
          submission,
        },
        {
  ...
  const HandleAdminAddNoteToChat = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminaddnotetochat/",
        {
          submission,
        },
        {
  ...
  const HandleMarkForManger = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminmarkformanger/",
        {
          submission,
        },
        {
  ...
  const HandleBlockUser = async (chat) => {
    ...
    try {
      const datas = await axios.post(
        "https://pharmacyonline.onrender.com/api/users/adminblockuseremail/",
        {
          submission,
        },
        {
