...
const MangeUsers = () => {
  ...
  const HandleGetAllUsers = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/users/getallusers",
        formData,
        {
  ...
  const HandleAddNoteToUser = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/users/addnotetouser",
  ...
  const HandleDeleteUser = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/Users/deleteuser",
  ...
  const handleDeactiviteUser = async (User) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/users/deactivateuser",
  ...
  const HandleUserEdit = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/users/updateuserinfo",
  ...
  const HandleAddNewUser = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-git-master-enstein01.vercel.app/api/users/adduseradmin",
            ...
            AllUsers.filter(function (User) {
              ...
              return (
                <div key={User._id} className={styles.AllUserstyle}>
                  ...
                  <div>User mobile: 0{User.mobilenumber}</div>
        ...
        <div className={styles.Editcomponent}>
          <div>
            ...
            <div className={styles.AllUserstyle}>
              ...
              <div>User mobile: 0{UserSelectedToEdit.mobilenumber}</div>
        ...
        <div className={styles.DeleteComponent}>
          <div>
            ...
            <div className={styles.AllUserstyle}>
              ...
              <div>User mobile: 0{UsersSelectedToDelete.mobilenumber}</div>
