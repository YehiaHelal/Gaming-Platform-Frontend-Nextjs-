...
const MangeOrders = () => {
  ...
  const HandleAddNoteToOrder = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/orders/orderaddnote/",
  ...
  const HandleDeleteOrder = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/orders/deleteorder",
  ...
  const handleOrderMarkCompleted = async (order) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/orders/markordercompleted",
  ...
  const HandleOrderEdit = async (e) => {
    ...
    try {
      const datas = await axios.post(
        "https://gaming-platform-backend-node-d7xn88c0u-enstein01.vercel.app/api/orders/updateOrder",
            ...
            AllOrders.filter(function (order) {
              ...
              return (
                <div key={order._id} className={styles.AllOrderStyle}>
                  ...
                  <div>User mobile number: 0{order.userData.mobilenumber}</div>
        ...
        <div className={styles.Editcomponent}>
          <div>
            ...
            <div className={styles.AllOrderStyle}>
              ...
              <div>
                User mobile number: 0{OrderSelectedToEdit.userData.mobilenumber}
                {/* 01234567890{" "} */}
              </div>
