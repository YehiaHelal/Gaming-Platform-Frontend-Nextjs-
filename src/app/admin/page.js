...
const Admin = () => {
  ...
  // Set Game Type choosed in Adding product
  const [gameTypeAddProduct, setGameTypeAddProduct] = useState();

  // Set Game Type choosed in Edit product
  ...
  const HandleAddNewProduct = async (e) => {
    ...
    // console.log(gameTypeAddProduct);
    ...
    if (gameTypeAddProduct) {
      formData.append("type", gameTypeAddProduct);
    }
            ...
            {showAddProductCom && (
              <div>
                ...
                >
                  ...
                  <div className={styles.AddNewProductFormItemTypeAdd}>
                    <div>Item Type</div>
                    <select
                      type="item"
                      name="itemtypeadd"
                      // value={gameType ? gameType : "Old School RuneScape"}
                      value={gameTypeAddProduct}
                      onChange={(e) => {
                        // console.log(e.target.value);
                        setGameTypeAddProduct(e.target.value);
            ...
            {showEditProductCom && AllItems && itemSelectedInEditCom && (
              <div className={styles.EditProductComponent}>
                ...
                >
                  ...
                  <div className={styles.AddNewProductFormItemType}>
                    <div>Item Type</div>
                    <select
                      type="item"
                      name="itemtype"
